...
$q = "INSERT INTO contato VALUES (NULL, '$nome', '$email');";

//Mata programa se não fizer conexão
$resultado = $conexao->query($q) or die(print_r($conexao->errorInfo())); 
//echo "Contato cadastrado com sucesso"; <- ativado somente para validar o tráfego
?>
...
//Recebendo e encaminhando informações, formulário encaminhado direto para BD
    echo'
        <div class="col-sm-9">
            <div class="container">
            <div id="formulario">
            <form action ="recebe_dados_telefone.php" method ="POST">
            ...
            echo '
            <br><label for="text">Telefone:</label>
            <br><input type="text" id="telefone" name="telefone" required>
            </div>';
            echo'<br><button type="submit" class="btn btn-primary">Salvar Contato</button></div></div></div></div>';
?>
</body>
</html>